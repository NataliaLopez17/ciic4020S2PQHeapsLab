...
public abstract class AbstractListPriorityQueue<K, V> extends AbstractPriorityQueue<K, V> {
	...
	/**
	 * Internal method to find the index of the element in list containing an entry
	 * having min key. Subclasses will implement as needed.
	 * 
	...
	/**
	 * This method is mainly for testing purposes. Elements (entries) are displayed
	 * as they are inside the internal list, from first to last; hence, in this
	 * case, they they are not seen in any particular order (increasing or
	 * decreasing), but just as they are in the list....
	 */
	public void display() {
		if (this.isEmpty())
