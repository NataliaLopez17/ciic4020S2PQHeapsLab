...
public class PriorityQueueTester3 {
	...
	public static void main(String[] args) {
		...
		pq = new UnsortedListPriorityQueue<String, String>(new StringComparator1());
		// // 1
		// pq = new SortedListPriorityQueue<String, String>(new StringComparator1());
		// // 2
		// pq = new HeapListPriorityQueue<String, String>(new StringComparator1());
		// // 3
